...
SELECT * FROM models WHERE brand_name LIKE 'Pontiac';
...
SELECT COUNT(*) FROM brands JOIN models ON brands.name = models.brand_name WHERE brands.name = 'Ford';
...
SELECT b.name, b.founded, m.name FROM BRANDS AS B FULL OUTER JOIN models AS m ON m.brand_name = b.name WHERE b.discontinued IS NULL AND b.founded IS NOT NULL;
...
SELECT m.name, m.brand_name, b.founded FROM models AS m LEFT JOIN brands AS b ON b.name = m.brand_name WHERE b.name = m.brand_name;
...
SELECT b.name, founded FROM brands AS b LEFT JOIN models AS m ON b.name = m.brand_name WHERE m.name IS NULL;
